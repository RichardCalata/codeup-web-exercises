...
var bill = parseFloat(prompt("bill"));
...
var price = parseFloat(prompt("price in dollars"));
var discount =parseFloat(prompt("discount percentage"));
var youPay = applyDiscount(price, discount);
console.log(youPay);
